...
export const InterestEventsScreen: React.FC = () => {
  const navigation = useNavigation();
  const interestList = useSelectorRoot(
    (state: RootState) => state.persist.userInfo.interest_event,
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={{paddingLeft: 5}}>
        <ItemsList dataList={interestList} message="Event" />
      </ScrollView>
    </View>
  );
};
